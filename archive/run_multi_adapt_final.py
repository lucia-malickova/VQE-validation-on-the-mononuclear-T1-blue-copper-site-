# run_multi_adapt_final.py — Cisty a agresivny Multi-ADAPT (Iba S+D pool)
...
def main():
    ...
    print(f"Pool = {len(pool)} operatorov (Iba ciste S+D)", flush=True)
    ...
    # VYSI K_ADD PRE VÄČŠÍ ZÁBER, VYŠŠÍ MAX_ITERS
    ...
    for it in range(1, MAX_ITERS+1):
        ...
        # L-BFGS-B s velmi prisnou toleranciou
